...
cx.setup(
    ...
    options={
        'build_exe': {
            'packages': ['tkinter','threading','os','socket','datetime','random',                 'numpy','requests','certifi','idna','urllib3','pandas','pytz','tzdata','six','openpyxl','cv2','pytesseract','PIL','packaging','pdf2image','PyPDF2','typing_extensions'
                       ] ,
