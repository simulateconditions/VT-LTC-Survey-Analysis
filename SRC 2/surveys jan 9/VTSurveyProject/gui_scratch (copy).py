...
def download_and_analyze():
    ...
    download_button = tkmacosx.Button(r_info,text='Download')
    ...
    update_button = tkmacosx.Button(r_info,text='Update Page Counts')
    ...
    analyze_button = tkmacosx.Button(analyze,text = 'Analyze')
