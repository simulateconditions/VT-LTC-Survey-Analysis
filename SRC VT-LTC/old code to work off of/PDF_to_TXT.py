...
#root directory
root_dir = os.path.join('Documents','Survey Statements')
...
ALR_bool = int(input('convert ALR? 0 or 1\n'))
if bool(ALR_bool):
    convert(ALR_pdf_files,ALR_path,ALR_path_new)
RCH_bool = int(input('convert RCH? 0 or 1\n'))
if bool(RCH_bool):
    convert(RCH_pdf_files,RCH_path,RCH_path_new)
SNF_bool = int(input('convert SNF? 0 or 1\n'))
if bool(SNF_bool):
    convert(SNF_pdf_files,SNF_path,SNF_path_new)
...
ALR_bool = int(input('convert ALR? 0 or 1\n'))
if bool(ALR_bool):
    work(ALR_pdf_files,ALR_path,ALR_path_new)
RCH_bool = int(input('convert RCH? 0 or 1\n'))
if bool(RCH_bool):
    work(RCH_pdf_files,RCH_path,RCH_path_new)
SNF_bool = int(input('convert SNF? 0 or 1\n'))
if bool(SNF_bool):
    work(SNF_pdf_files,SNF_path,SNF_path_new)
...
ALR_bool = int(input('convert ALR? 0 or 1\n'))
if bool(ALR_bool):
    txt3(ALR_pdf_files,ALR_path,ALR_path_new)
RCH_bool = int(input('convert RCH? 0 or 1\n'))
if bool(RCH_bool):
    txt3(RCH_pdf_files,RCH_path,RCH_path_new)
SNF_bool = int(input('convert SNF? 0 or 1\n'))
if bool(SNF_bool):
    txt3(SNF_pdf_files,SNF_path,SNF_path_new)
